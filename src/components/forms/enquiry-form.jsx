...
// ✅ Shared styles
const inputStyle = `
  text-[10px] sm:text-[10px] xl:text-[11px] 2xl:text-[12px] 3xl:text-[16px] leading-none font-medium text-white placeholder:text-white/90 w-full !h-[30px] 2xl:!h-[35px] 3xl:!h-[40px] bg-none border-transparent border-b-[#424242] px-0 
